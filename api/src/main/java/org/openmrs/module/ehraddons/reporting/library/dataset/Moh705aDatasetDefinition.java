...
public class Moh705aDatasetDefinition extends EhrAddOnBaseDataSet {
	...
	private void getBilharzia(CohortIndicatorDataSetDefinition dsd, String indParam) {
		...
		dsd.addColumn("B1", "Bilharzia-Day 1", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getBilharziaList(), 1), indParam), "");
		dsd.addColumn("B2", "Bilharzia-Day 2", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getBilharziaList(), 2), indParam), "");
		dsd.addColumn("B3", "Bilharzia-Day 3", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getBilharziaList(), 3), indParam), "");
		dsd.addColumn("B4", "Bilharzia-Day 4", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getBilharziaList(), 4), indParam), "");
		dsd.addColumn("B5", "Bilharzia-Day 5", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getBilharziaList(), 5), indParam), "");
		dsd.addColumn("B6", "Bilharzia-Day 6", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getBilharziaList(), 6), indParam), "");
		dsd.addColumn("B7", "Bilharzia-Day 7", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getBilharziaList(), 7), indParam), "");
		dsd.addColumn("B8", "Bilharzia-Day 8", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getBilharziaList(), 8), indParam), "");
		dsd.addColumn("B9", "Bilharzia-Day 9", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getBilharziaList(), 9), indParam), "");
		dsd.addColumn("B10", "Bilharzia-Day 10", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getBilharziaList(), 10), indParam), "");
		dsd.addColumn("B11", "Bilharzia-Day 11", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getBilharziaList(), 11), indParam), "");
		dsd.addColumn("B12", "Bilharzia-Day 12", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getBilharziaList(), 12), indParam), "");
		dsd.addColumn("B13", "Bilharzia-Day 13", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getBilharziaList(), 13), indParam), "");
		dsd.addColumn("B14", "Bilharzia-Day 14", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getBilharziaList(), 14), indParam), "");
		dsd.addColumn("B15", "Bilharzia-Day 15", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getBilharziaList(), 15), indParam), "");
		dsd.addColumn("B16", "Bilharzia-Day 16", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getBilharziaList(), 16), indParam), "");
		dsd.addColumn("B17", "Bilharzia-Day 17", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getBilharziaList(), 17), indParam), "");
		dsd.addColumn("B18", "Bilharzia-Day 18", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getBilharziaList(), 18), indParam), "");
		dsd.addColumn("B19", "Bilharzia-Day 19", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getBilharziaList(), 19), indParam), "");
		dsd.addColumn("B20", "Bilharzia-Day 20", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getBilharziaList(), 20), indParam), "");
		dsd.addColumn("B21", "Bilharzia-Day 21", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getBilharziaList(), 21), indParam), "");
		dsd.addColumn("B22", "Bilharzia-Day 22", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getBilharziaList(), 22), indParam), "");
		dsd.addColumn("B23", "Bilharzia-Day 23", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getBilharziaList(), 23), indParam), "");
		dsd.addColumn("B24", "Bilharzia-Day 24", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getBilharziaList(), 24), indParam), "");
		dsd.addColumn("B25", "Bilharzia-Day 25", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getBilharziaList(), 25), indParam), "");
		dsd.addColumn("B26", "Bilharzia-Day 26", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getBilharziaList(), 26), indParam), "");
		dsd.addColumn("B27", "Bilharzia-Day 27", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getBilharziaList(), 27), indParam), "");
		dsd.addColumn("B28", "Bilharzia-Day 28", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getBilharziaList(), 28), indParam), "");
		dsd.addColumn("B29", "Bilharzia-Day 29", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getBilharziaList(), 29), indParam), "");
		dsd.addColumn("B30", "Bilharzia-Day 30", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getBilharziaList(), 30), indParam), "");
		dsd.addColumn("B31", "Bilharzia-Day 31", ReportUtils.map(
	...
	private void getMalnutrition(CohortIndicatorDataSetDefinition dsd, String indParam) {
		...
		dsd.addColumn("MN1", "Malnutrition-Day 1", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getMalnutritionList(), 1), indParam), "");
		dsd.addColumn("MN2", "Malnutrition-Day 2", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getMalnutritionList(), 2), indParam), "");
		dsd.addColumn("MN3", "Malnutrition-Day 3", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getMalnutritionList(), 3), indParam), "");
		dsd.addColumn("MN4", "Malnutrition-Day 4", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getMalnutritionList(), 4), indParam), "");
		dsd.addColumn("MN5", "Malnutrition-Day 5", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getMalnutritionList(), 5), indParam), "");
		dsd.addColumn("MN6", "Malnutrition-Day 6", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getMalnutritionList(), 6), indParam), "");
		dsd.addColumn("MN7", "Malnutrition-Day 7", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getMalnutritionList(), 7), indParam), "");
		dsd.addColumn("MN8", "Malnutrition-Day 8", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getMalnutritionList(), 8), indParam), "");
		dsd.addColumn("MN9", "Malnutrition-Day 9", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getMalnutritionList(), 9), indParam), "");
	...
	private void getAnaemia(CohortIndicatorDataSetDefinition dsd, String indParam) {
		//String indParam = "startDate=${startDate},endDate=${endDate}";
		dsd.addColumn("AN1", "Anaemia-Day 1", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getAnaemiaList(), 1), indParam), "");
		dsd.addColumn("AN2", "Anaemia-Day 2", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getAnaemiaList(), 2), indParam), "");
		dsd.addColumn("AN3", "Anaemia-Day 3", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getAnaemiaList(), 3), indParam), "");
		dsd.addColumn("AN4", "Anaemia-Day 4", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getAnaemiaList(), 4), indParam), "");
		dsd.addColumn("AN5", "Anaemia-Day 5", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getAnaemiaList(), 5), indParam), "");
		dsd.addColumn("AN6", "Anaemia-Day 6", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getAnaemiaList(), 6), indParam), "");
		dsd.addColumn("AN7", "Anaemia-Day 7", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getAnaemiaList(), 7), indParam), "");
		dsd.addColumn("AN8", "Anaemia-Day 8", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getAnaemiaList(), 8), indParam), "");
		dsd.addColumn("AN9", "Anaemia-Day 9", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getAnaemiaList(), 9), indParam), "");
		dsd.addColumn("AN10", "Anaemia-Day 10", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getAnaemiaList(), 10), indParam), "");
		dsd.addColumn("AN11", "Anaemia-Day 11", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getAnaemiaList(), 11), indParam), "");
		dsd.addColumn("AN12", "Anaemia-Day 12", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getAnaemiaList(), 12), indParam), "");
		dsd.addColumn("AN13", "Anaemia-Day 13", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getAnaemiaList(), 13), indParam), "");
		dsd.addColumn("AN14", "Anaemia-Day 14", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getAnaemiaList(), 14), indParam), "");
		dsd.addColumn("AN15", "Anaemia-Day 15", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getAnaemiaList(), 15), indParam), "");
		dsd.addColumn("AN16", "Anaemia-Day 16", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getAnaemiaList(), 16), indParam), "");
		dsd.addColumn("AN17", "Anaemia-Day 17", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getAnaemiaList(), 17), indParam), "");
		dsd.addColumn("AN18", "Anaemia-Day 18", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getAnaemiaList(), 18), indParam), "");
		dsd.addColumn("AN19", "Anaemia-Day 19", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getAnaemiaList(), 19), indParam), "");
		dsd.addColumn("AN20", "Anaemia-Day 20", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getAnaemiaList(), 20), indParam), "");
		dsd.addColumn("AN21", "Anaemia-Day 21", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getAnaemiaList(), 21), indParam), "");
		dsd.addColumn("AN22", "Anaemia-Day 22", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getAnaemiaList(), 22), indParam), "");
		dsd.addColumn("AN23", "Anaemia-Day 23", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getAnaemiaList(), 23), indParam), "");
		dsd.addColumn("AN24", "Anaemia-Day 24", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getAnaemiaList(), 24), indParam), "");
		dsd.addColumn("AN25", "Anaemia-Day 25", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getAnaemiaList(), 25), indParam), "");
		dsd.addColumn("AN26", "Anaemia-Day 26", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getAnaemiaList(), 26), indParam), "");
		dsd.addColumn("AN27", "Anaemia-Day 27", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getAnaemiaList(), 27), indParam), "");
		dsd.addColumn("AN28", "Anaemia-Day 28", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getAnaemiaList(), 28), indParam), "");
		dsd.addColumn("AN29", "Anaemia-Day 29", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getAnaemiaList(), 29), indParam), "");
		dsd.addColumn("AN30", "Anaemia-Day 30", ReportUtils.map(
			moh705aIndicator.getAllPatientsWithDiagnosis(DiagnosisLists.getAnaemiaList(), 30), indParam), "");
		dsd.addColumn("AN31", "Anaemia-Day 31", ReportUtils.map(
