...
public class Moh717CohortDefinition {
	 ...
	 */
		...
		cd.setQuery(Moh717Queries.getSpecialClinicPatients(
				EhrAddonsMetadata.getAdultsInitialEncounterType().getEncounterTypeId(),
				EhrAddonsMetadata.getAdultReturnEncounterType().getEncounterTypeId(),
				EhrAddonsMetadata.getPedsInitialEncounterType().getEncounterTypeId(),
				EhrAddonsMetadata.getPedsReturnEncounterType().getEncounterTypeId(),
				EhrAddonsMetadata.getCheckInEncounterType().getEncounterTypeId(),
				EhrAddonsMetadata.getAncEncounterType().getEncounterTypeId(),
				EhrAddonsConstants.getConcept(EhrAddonsConstants._EhrAddOnConcepts.SPECIAL_CLINIC).getConceptId(), answer));
